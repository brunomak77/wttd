...
class SubscribePostTest(TestCase):
    ...
    def test_post(self):
        """ Test post should redirect to /inscricao/"""
    ...
    def test_subscription_email_to(self):
        email = mail.outbox[0]
        expect = ['contato@eventex.com.br', 'brunomakhl@hotmail.com']
        self.assertEqual(expect, email.to)

    def test_subscription_email_body(self):
        email = mail.outbox[0]

        self.assertIn('Bruno Makhohl', email.body)
        self.assertIn('12345678901', email.body)
        self.assertIn('brunomakhl@hotmail.com', email.body)
        self.assertIn('11-981934970', email.body)
